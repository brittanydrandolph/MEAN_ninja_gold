...
myString = "9"; // the number 9 is not assignable as a string. You either need to change the value or put "9"
...
// 9 is a number and not a string
...
//Make middle name optional with a ?
...
const jay = {
  firstName: "Jay",
  lastName: "Patel",
  belts: 4 // belt needs to be changed to belts
}
...
// added some parentheses, a set of curly braces and took out a pair of curly braces
---
class Elephant {
